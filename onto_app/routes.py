...
client_key = "xYyS6wKPUK94ma50gsxVDaC80"
client_secret = 'DZJ6U1Ybw9HJknoiKaOoYD0hBJe915dgB4rHjAGH0rde5IfKUY'
final_data = ['.'.join(ontology.split('/')[-1].split('.')[:-1]) for ontology in get_ontologies_on_server()]
...
def upload_ontology():
    ...
    final_data.append(ontology_name)
